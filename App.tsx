...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (import.meta.env.MODE === 'staging') {
      console.log("Modo STAGING detectado: Forzando rol superadmin para pruebas.");
        ...
        <div className="flex flex-col min-h-screen">
          ...
          <main className="flex-1 relative">
            ...
            <div className="container mx-auto relative">
              {/* 🏷️ STICKY BRAND LOGO (Shifted Right - Inside white container) */}
              <div className="hidden 2xl:block absolute top-0 left-6 h-full z-50 pointer-events-none">
                <div className="sticky top-24 pt-10 pointer-events-auto">
                  <div className="group relative">
                    <div className="absolute inset-0 bg-blue-500/10 rounded-full blur-2xl scale-95 group-hover:scale-110 transition-all duration-500"></div>
                    <img
                      src="/brand_logo_v3.png"
                      alt="Brand Logo"
                      className="relative w-44 h-44 object-cover rounded-full border-4 border-white shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2"
                    />
                  </div>
                </div>
              </div>
